...
def compute_wot_rank(trust_graph: nx.DiGraph, truster: int, trustee: int) -> int:
    """
    ...
    try:
        ...
        rank = nx.shortest_path_length(
            trust_graph, source=truster, target=trustee
        )  # , weight='weight')
...
def compute_wot_score(
    trust_graph: nx.DiGraph, truster: int, trustee: int, verbose: bool = False
) -> int:
    """
